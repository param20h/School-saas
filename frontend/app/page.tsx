...
export default function Home() {
    return (
        <main className="min-h-screen bg-gradient-to-b from-white to-slate-50">
            {/* Navigation */}
            <nav className="border-b border-slate-200/60 bg-white/80 backdrop-blur-sm sticky top-0 z-50 shadow-sm">
                <div className="container mx-auto px-6 py-5">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <Link href="/login?role=admin" className="px-5 py-2.5 bg-slate-900 text-white text-sm font-medium rounded-lg hover:bg-slate-800 transition-all shadow-sm hover:shadow-md active:scale-[0.98]">
                                Get Started
                            </Link>
                        </div>
                    </div>
            ...
            <section className="relative container mx-auto px-6 pt-24 pb-16 animate-fade-in">
                <div className="grid lg:grid-cols-12 gap-16 items-start">
                    <div className="lg:col-span-7 animate-slide-in-left">
                        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 border border-slate-200 rounded-full mb-8 bg-white shadow-sm">
                        ...
                        <div className="flex flex-wrap items-center gap-4 mb-16">
                            <Link href="/login?role=admin" className="group px-7 py-3.5 bg-slate-900 text-white font-medium rounded-lg hover:bg-slate-800 transition-all shadow-md hover:shadow-lg active:scale-[0.98] flex items-center gap-2.5">
                                Get Started Free
                                <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                            </Link>
                            <Link href="#demo" className="px-7 py-3.5 border border-slate-300 text-slate-700 font-medium rounded-lg hover:bg-slate-50 transition-all hover:shadow-sm active:scale-[0.98]">
                                View Demo
                            </Link>
                        </div>
                    ...
                    <div className="lg:col-span-5 animate-slide-in-right">
                        <div className="relative">
                            <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-8 space-y-4 shadow-lg">
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={index} className="group bg-white border border-slate-200/60 rounded-xl p-7 hover:shadow-lg hover:border-slate-300 transition-all duration-300 hover:-translate-y-1">
            ...
            {/* Role-Based Access Sec text-center">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        <Link
                            key={item.role}/60 rounded-xl p-7 hover:border-slate-900 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                        >
                            <div className="w-12 h-12 bg-slate-100 rounded-lg flex items-center justify-center mb-5 group-hover:bg-slate-900 transition-colors">
                                <GraduationCap className="w-8 h-8 text-slate-700 group-hover:text-white transition-colors" />
                            </divded-xl p-7 hover:border-slate-900 hover:shadow-lg transition-all"
                        >
